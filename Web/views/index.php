    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1,#navbar">
            ...
            <div class="gtco-container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <a href="images/14THVISA2.jpg" class="fh5co-project-item image-popup">
                            <figure>
            ...
            <!-- Modal content-->
                    ...
                    <div class="wrapper fadeInDown">
                        <div id="formContent">
                            ...
                            <div class="row">
                                <div class="col-xs-11"> <h2 class="active" id="h2_signin"> Sign In </h2></div>
                                <div class="col-xs-1"> <button type="button" id="colsemodelbtn" class="close" data-dismiss="modal">&times;</button></div>
